...
The Great Subjectification
        │
        ├── pluralizes representation
        │       └── Bring your own model
        │
        ├── creates justificatory pressure
        │       └── Epistemic debt
        │
        ├── creates provenance pressure
        │       └── Epistemic chain of custody
        │               └── “Knowledge needs a return address”
        │
        └── appears narratologically as
                └── Diegetization
```
...
- [Bring your own model](../entries/bring-your-own-model.md)
